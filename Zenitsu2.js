...
switch(command) {
    ...
    let { data } = await axios.get('https://api.github.com/repos/ssmarw/Zenitsu-Bot2');
    teks = `*Shehan it Script*\n\n*GitHub*: https://github.com/ssmarw/Zenitsu-Bot2\n\nDont forget to follow me on *GitHub* and give a ⭐️ to my projects. `
    let buttons = [
...
break  	  
    ...
    //var link2 = `https://wa.me/687824287`
...
Auto Bot By ShehanShah With You Forever!! 🐶🤚
...
case 'lava': case 'rockart': case 'bloodglas': case 'halloween': case 'darkgold': case 'joker': case 'wicker':
 case 'firework': case 'skeleton': case 'blackpinkart': case 'sand': case 'glue': case '1917': case 'leaves': case 'demon': {
             ...
             let anutexpro = await maker.textpro(link, q)
                Deepak.sendMessage(m.chat, { image: { url: anutexpro }, caption: `Generated by Auto Bot` }, { quoted: m })
             }
             break
case'glitch3':
...
maker.textpro("https://textpro.me/create-glitch-text-effect-style-tik-tok-983.html", [
    `${teks1}`,`${teks2}`])
  .then((data) => Deepak.sendMessage(m.chat, { image: { url: data }, caption: `Generated by Auto Bot` }, { quoted: m }))
...
maker.textpro("https://textpro.me/create-3d-neon-light-text-effect-online-1028.html", [
    `${q}`,])
  .then((data) => Deepak.sendMessage(m.chat, { image: { url: data }, caption: `MGenerated by Auto Bot` }, { quoted: m }))
  .catch((err) => console.log(err));
   break
...
const txt = `Do you love AutoBot? Then we are the same.`
const Deepakarray= [
